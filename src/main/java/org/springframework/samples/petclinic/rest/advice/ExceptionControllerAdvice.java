...
public class ExceptionControllerAdvice {
    ...
    @ResponseBody
    public ResponseEntity<ProblemDetail> handleInvalidParameters(Exception e, HttpServletRequest request) {
        return ResponseEntity.badRequest().body(detailBuild(e, HttpStatus.BAD_REQUEST,
            request.getRequestURL(), ERROR_INVALID_REQUEST));
    }

    @ExceptionHandler(org.springframework.security.access.AccessDeniedException.class)
    @ResponseBody
    public ResponseEntity<ProblemDetail> handleAccessDenied(Exception e, HttpServletRequest request) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(detailBuild(e, HttpStatus.FORBIDDEN,
            request.getRequestURL(), "Access denied"));
    }
    ...
    public ResponseEntity<ProblemDetail> handleResponseStatusException(
        ...
        ProblemDetail detail = ProblemDetail.forStatusAndDetail(e.getStatusCode(),
            Objects.toString(e.getReason(), "The request could not be processed"));
